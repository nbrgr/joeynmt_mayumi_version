...
def prepare(data_dir, size, seed=None):
    ...
    df = pd.read_csv(Path(data_dir) / 'en-ja' / 'en-ja.bicleaner05.txt',
                     header=None, names=dtype.keys(), sep='\t', encoding='utf8',
                     quoting=3, keep_default_na=False, na_values='', dtype=dtype)
