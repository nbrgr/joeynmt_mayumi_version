...
class RecurrentEncoder(Encoder):
    ...
    def _check_shapes_input_forward(self, embed_src: Tensor,
                                    src_length: Tensor, mask: Tensor) -> None:
        """
    ...
    def forward(self, embed_src: Tensor, src_length: Tensor, mask: Tensor,
        ...
        packed = pack_padded_sequence(embed_src,
                                      src_length.cpu(),
                                      batch_first=True)
        ...
        hidden_concat = torch.cat([fwd_hidden_last, bwd_hidden_last],
                                  dim=2).squeeze(0)
